...
loader.load(
    ...
    (gltf) => {
        ...
        // Listen for the custom event from the slider
        window.addEventListener('sliderUpdated', function(e) {
          ...
          console.log("Received slider value:", sliderValue);
            ...
            if (sliderValue === 20) {
              console.log("Attempting to play 'sus stangaAction.001':", actions['sus stangaAction.001']);
                actions['sus stangaAction.001'].reset().play();
            } else if (sliderValue === 47) {
              console.log("Attempting to play 'sus dreaptaAction.001':", actions['sus dreaptaAction.001']);
                actions['sus dreaptaAction.001'].reset().play();
            } else if (sliderValue === 74) {
              console.log("Attempting to play 'jos stangaAction.001':", actions['jos stangaAction.001']);
                actions['jos stangaAction.001'].reset().play();
            } else if (sliderValue === 100) {
              console.log("Attempting to play 'jos dreaptaAction.001':", actions['jos dreaptaAction.001']);
                actions['jos dreaptaAction.001'].reset().play();
            }
        });
